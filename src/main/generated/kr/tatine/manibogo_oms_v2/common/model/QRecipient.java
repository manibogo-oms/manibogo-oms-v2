...
public class QRecipient extends BeanPath<Recipient> {
    ...
    public final kr.tatine.manibogo_oms_v2.location.domain.address.QAddress address;
    ...
    public QRecipient(Class<? extends Recipient> type, PathMetadata metadata, PathInits inits) {
        ...
        this.address = inits.isInitialized("address") ? new kr.tatine.manibogo_oms_v2.location.domain.address.QAddress(forProperty("address")) : null;
