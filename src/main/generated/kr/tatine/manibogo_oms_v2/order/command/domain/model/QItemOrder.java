...
public class QItemOrder extends EntityPathBase<ItemOrder> {
    ...
    private static final long serialVersionUID = 181595146L;
    ...
    public final kr.tatine.manibogo_oms_v2.order.command.domain.model.vo.QItemOrderNote note;

    public final kr.tatine.manibogo_oms_v2.order.command.domain.model.vo.QItemOrderNumber number;
    ...
    public final EnumPath<kr.tatine.manibogo_oms_v2.order.command.domain.model.vo.ItemOrderState> state = createEnum("state", kr.tatine.manibogo_oms_v2.order.command.domain.model.vo.ItemOrderState.class);
    ...
    public final ListPath<kr.tatine.manibogo_oms_v2.product.command.domain.VariantId, kr.tatine.manibogo_oms_v2.product.command.domain.QVariantId> variants = this.<kr.tatine.manibogo_oms_v2.product.command.domain.VariantId, kr.tatine.manibogo_oms_v2.product.command.domain.QVariantId>createList("variants", kr.tatine.manibogo_oms_v2.product.command.domain.VariantId.class, kr.tatine.manibogo_oms_v2.product.command.domain.QVariantId.class, PathInits.DIRECT2);
    ...
    public QItemOrder(Class<? extends ItemOrder> type, PathMetadata metadata, PathInits inits) {
        ...
        this.note = inits.isInitialized("note") ? new kr.tatine.manibogo_oms_v2.order.command.domain.model.vo.QItemOrderNote(forProperty("note")) : null;
        this.number = inits.isInitialized("number") ? new kr.tatine.manibogo_oms_v2.order.command.domain.model.vo.QItemOrderNumber(forProperty("number")) : null;
        ...
        this.shippingInfo = inits.isInitialized("shippingInfo") ? new kr.tatine.manibogo_oms_v2.order.command.domain.model.vo.QShippingInfo(forProperty("shippingInfo")) : null;
