package kr.tatine.manibogo_oms_v2.location.ui;
...
public class RegionFragmentController {
    ...
    private final RegionQueryUseCase queryUseCase;
    ...
    public String options(@RequestParam int level,
                          ...
                          Model model) {
        model.addAttribute("regions", queryUseCase.findAll(level, parent));
